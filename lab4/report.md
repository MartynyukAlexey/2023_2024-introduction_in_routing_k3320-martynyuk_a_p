...
Date of create: 20.01.2025

Date of finished: 22.01.2025

# Лабораторная работа №4 "Эмуляция распределенной корпоративной сети связи, настройка iBGP, организация L3VPN, VPLS"

## Ход работы:

1. Был написан файл lab4.clab.yaml, описывающий все устройства и соединения между ними через mgmt сеть. Его можно посмотреть в этой же папке(lab4.clab.yaml). С помощью команды sudo containerlab deploy были запущены сетевые устройства для выполнения 1 и 2 части лабораторной:

![table](./assets/table.png)

### Part 1. 

2.1. Далее прописывалась конфигурация для создания топологии и выполнения 1 части задания(iBGP RR Cluster, VRF на 3 роутерах, RD и RT)
...
![schema_part1](./assets/part1/schema1.png)

Для проверки связности vrf на всех роутерах посмотрел таблицу /routing bgp vpnv4-route print и пропинговал 2 других роутера

**R01.SPB**

![SPB_routeing](./assets/part1/SPB_routes.png)

**R01.NY**

![NY_routeing](./assets/part1/NY_routes.png)


**R01.SVL**

![SVL_routeing](./assets/part1/SVL_routes.png)

### Part 2. 

2.2 Для второй части была прописана следующая представленная ниже конфигурация роутеров (VPLS, IP адресация на всех PC в одной сети):
...
И аналогично предыдущим работам linux-устройствам(клиентам) также в ручную были выданы IP-адреса из одной сети в соответствии со схемой:

![schema_part2](./assets/part2/schema2.png)

И чтобы убедиться в работоспособности сети я пропинговал все PC между собой:

**Ping from PC1 to PC2 and PC3**

![ping_pc1](./assets/part2/ping1.png)

**Ping from PC2 to PC3 and PC1**

![ping_pc2](./assets/part2/ping2.png)

**Ping from PC3 to PC2 and PC1**

![ping_pc3](./assets/part2/ping3.png)

## Вывод:

В результате выполнения лабораторной работы были освоены методы работы с протоколами BGP, MPLS и изучены на практике правила организации L3VPN и VPLS.